...
def prompt_user_and_create_webpage(caption, ocr_data):
    user_input = input("\nShould we make this image accessible? (yes/no): ").strip().lower()
    if user_input in ['yes', 'y']:
        print("Creating webpage with image and OCR text...")
        # Assuming image_url is globally accessible or passed as a parameter
        # For this function to work, image_url should be known here
        # You can adjust the code to pass image_url as needed
        # Here, we'll assume image_url is a global variable
